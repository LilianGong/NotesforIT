...
>## Basic Command Lines for WINDOWS
...
* #### Archive in WINDOWS<br>
Compress-Archive -Path file1 file2 file3 file.zip *make zipfile with file1 file2 and file3 and name it as file.zip*<br>

* #### *modify software using *chocolatey* <br>
Register-PackageSource -Name chocolatey -ProviderName Chocolatey -Location http://chocolatey.org/api/v2/ *install the chocolatey* <br>
Install -Package -Name softw -Source chocolatey *install softw from chocolatey*<br>
Choco Uninstall  softw *uninstall softw by chocolatey*<br>
Get-Package *check status of all installed softw*<br>
...
* ####  Disk Management<br>
DiskPart *enter the disk management tools in the command line* <br> 
list disk *list all the disks currently exist in the computer* <br> 
select disk 1 *select a certain disk* <br>
clean *wipe all data from disk 1* <br>
create partition primary --> select partition 1 --> active  *create a partition, select and activate it* <br>
format FS = NTFS my_first_partition quick *format the partition as NTFS, name it as my_first_partition and the formatting type is 'quick'* <br>
Chkdsk /F D: *check disk status* <br>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzEzNzUwMTMyXX0=
-->